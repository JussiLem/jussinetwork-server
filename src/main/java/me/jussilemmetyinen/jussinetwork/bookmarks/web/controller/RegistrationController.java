...
public class RegistrationController {
  ...
  @Autowired private ISecurityUserService securityUserService;
  ...
  public GenericResponse registerUserAccount(
    ...
    LOGGER.atConfig().log("Registering user account with information: {}", accountDto);
  ...
  public void authWithHttpServletRequest(
    ...
    try {
      ...
      LOGGER.atSevere().log("Error while login ", e);
    }
  }
