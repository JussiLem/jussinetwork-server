...
public class User {
    ...
    public void setEmail(final String username) {this.email = username; }
    ...
    public void setUsing2FA(boolean isUsing2FA) { this.isUsing2FA = isUsing2FA; }
